 ...
 */
function isPropsObject(props?: SweetComponentProps): props is SweetComponentProps {
...
export function hasProps(
    props?: SweetComponentProps
): props is SweetComponentProps {
 ...
 */
export function hasChildren(props?: SweetComponentProps): boolean {
 ...
 */
export function getPropKeys(props?: SweetComponentProps): string[] {
 ...
 * ```
 */
export function hasPropKeys(
    props?: SweetComponentProps,
    checkKeys: string[] = [],
    checkMode: CheckMode = "every"
): boolean {
 ...
 * // true
 */
export function hasRenderableChildren(props?: SweetComponentProps): boolean {
